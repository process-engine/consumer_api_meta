    ...
    stage('Consumer API Tests') {
      steps {
        script {
          ...
          server_image.inside("${node_env} ${db_storage_path_correlation} ${db_storage_path_process_model} ${db_storage_path_flow_node_instance} ${db_storage_path_timer} ${consumer_api_mode} ${junit_report_path} ${config_path}") {
