...
describe('ConsumerAPI: GetEventsForProcessModel', () => {
  ...
  describe('Pagination', () => {
    ...
    it('should apply no limit, an offset of 5 and return 5 items', async () => {
      ...
      const eventList = await testFixtureProvider
        .consumerApiClient
        .getEventsForProcessModel(defaultIdentity, processModelId, 5);
    ...
    it('should apply no offset, a limit of 2 and return 2 items', async () => {
      ...
      const eventList = await testFixtureProvider
        .consumerApiClient
        .getEventsForProcessModel(defaultIdentity, processModelId, 0, 2);
    ...
    it('should apply an offset of 5, a limit of 2 and return 2 items', async () => {
      ...
      const eventList = await testFixtureProvider
        .consumerApiClient
        .getEventsForProcessModel(defaultIdentity, processModelId, 5, 2);
    ...
    it('should apply an offset of 7, a limit of 5 and return 3 items', async () => {
      ...
      const eventList = await testFixtureProvider
        .consumerApiClient
        .getEventsForProcessModel(defaultIdentity, processModelId, 7, 5);
    ...
    it('should return all items, if the limit is larger than the max number of records', async () => {
      ...
      const eventList = await testFixtureProvider
        .consumerApiClient
        .getEventsForProcessModel(defaultIdentity, processModelId, 0, 20);
    ...
    it('should return an empty Array, if the offset is out of bounds', async () => {
      ...
      const eventList = await testFixtureProvider
        .consumerApiClient
        .getEventsForProcessModel(defaultIdentity, processModelId, 1000);
