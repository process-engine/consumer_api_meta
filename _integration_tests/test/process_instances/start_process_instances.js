...
const testCase = 'ConsumerAPI:   POST  ->  /process_models/:process_model_id/start?start_callback_type=1&start_event_id=:start_event_id';
...
describe(`ConsumerAPI: ${testCase}`, () => {
  ...
  const processModelMultipleStartEventsId = 'test_consumer_api_multiple_start_events';
  ...
  it('should start and finish a ProcessInstance with one start event, if the payload is not provided', async () => {
